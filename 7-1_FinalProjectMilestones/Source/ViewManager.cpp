...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	// Add scroll callback for adjusting the speed of the movement
...
/***********************************************************
* Scroll_Callback() - Added to ViewManager.h as public method
*
* This method is automatically called from GLFW whenever
* the scroll wheel is used within the active GLFW display
* window.
***********************************************************/
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	// process camera panning up and down - Added functionality
...
void ViewManager::PrepareSceneView()
{
	...
	// define the current projection matrix based on the current projection mode 
